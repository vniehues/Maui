...
public class MauiPopup : UIViewController
{
	...
	public void SetElement(IPopup element)
	{
		...
		var rootViewController = UIApplication.SharedApplication.KeyWindow?.RootViewController ?? throw new InvalidOperationException($"{nameof(mainPage.ViewController)} cannot be null");
